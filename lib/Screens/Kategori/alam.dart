...
class Alam extends StatefulWidget {
  Alam() : super();

  @override
  AlamState createState() => AlamState();
}

class AlamState extends State<Alam> {
          ...
          Expanded(
            child: FutureBuilder <List<Locations>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<Locations> data = snapshot.data.where((c) => c.category == 'alam').toList();
                  return
                    ListView.builder(
