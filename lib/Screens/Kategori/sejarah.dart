...
class Sejarah extends StatefulWidget {
  ...
  @override
  SejarahState createState() => SejarahState();
}

class SejarahState extends State<Sejarah> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(fit: BoxFit.fill,
                image: new AssetImage('assets/images/bannersejarah.png'),
              ),
            ),
          ),
          Expanded(
            child: FutureBuilder <List<Locations>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<Locations> data = snapshot.data.where((c) => c.category == 'sejarah').toList();
                  return
                    ListView.builder(
