...
class Edukasi extends StatefulWidget {
  ...
  @override
  EdukasiState createState() => EdukasiState();
}

class EdukasiState extends State<Edukasi> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(fit: BoxFit.fill,
                image: new AssetImage('assets/images/banneredukasi.png'),
              ),
            ),
          ),
          Expanded(
            child: FutureBuilder <List<Locations>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<Locations> data = snapshot.data.where((c) => c.category == 'pendidikan').toList();
                  return
                    ListView.builder(
