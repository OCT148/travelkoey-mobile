...
class Religi extends StatefulWidget {
  Religi() : super();

  @override
  ReligiState createState() => ReligiState();
}

class ReligiState extends State<Religi> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(fit: BoxFit.fill,
                image: new AssetImage('assets/images/bannerreligi.png'),
              ),
            ),
          ),
          Expanded(
            child: FutureBuilder <List<Locations>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<Locations> data = snapshot.data.where((c) => c.category == 'religi').toList();
                  return
                    ListView.builder(
